...
O mecanismo que sustenta isso — a fronteira por diretório, o fluxo de sync e o manifest `pristine.lock.json` verificado no CI — está documentado no [AGENTS.md](AGENTS.md).
