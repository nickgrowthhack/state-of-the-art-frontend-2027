...
segurança). O usuário selecionou todos os grupos de achados. Execute na ordem
...
|-------|--------|------------|---------|------------|--------|
| [001](001-lint-que-morde.md) | Tornar o lint um gate real | P1 | S | — | TODO |
...
| [009](009-spike-vitrine-design-system.md) | Spike: vitrine do design system + dark mode | P3 | M | 003, 007 | TODO |
...
- **009 exige 003 e 007**: o spike recompõe a home — sem a fiação de fontes e o
  conteúdo próprio, ele prototiparia em cima de código que vai mudar.
...
- **010 após 001–005** (soft): o spike depende de confiar no CI e na suite e2e
  como harness.
- **008 é independente**, mas se landar antes de 009, os componentes novos do
  spike já nascem com a convenção de teste (o plano 009 cobra isso).
